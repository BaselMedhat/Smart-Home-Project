...
{
//setting these wires which act as a communication between the 2 microcontrollers
DIO_setPinDir(DIO_PINA7,DIO_OUTPUT);
DIO_setPinDir(DIO_PINA6,DIO_OUTPUT);
DIO_setPinDir(DIO_PINA5,DIO_OUTPUT);
//this interrupt is activated only when the user want to access the system remotely
u8 msg[]="\rA user need to access. press k to allow the user: ";
UART_sendString(msg);
